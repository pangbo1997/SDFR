...
from eval_metric import cal_vsd_error,cal_add_error
from pytorch3d.io import load_objs_as_meshes, load_obj
import psutil
def run_SymmICP(data_loader,dataset_dir,result_file,model_path,render=False):
    record={}
    R_error_list=[]
    t_error_list=[]
    pred_pose_list=[]
    ...
    for i,(src_pts_file,trg_pts_file,src_pts,trg_pts,init_pose,gt_pose) in tqdm(enumerate(data_loader)):
        ...
        try:
            ...
            for child in parent.children(recursive=True):  # 结束所有子进程
                child.kill()
            parent.kill()  # 杀死父进程
            process.wait() 
    ...
    for model_path in model_path_list:
        ...
        for _dir in os.listdir(render_path):
            ...
            if not os.path.exists(result_file): 
                ...
                # import pdb;pdb.set_trace()
                run_SymmICP(dataloader,dataset_dir,result_file,model_path,render)
